...
export class SidenavComponent implements OnInit{
  ...
  MenuDisplay(){
    ...
    this.missingperson= this.currentrole=='Adminstrator' || this.currentrole=='Public' || this.currentrole== 'Volunteer' || this.currentrole=='First Responder' ||this.currentrole=='Emergency Responder' ||this.currentrole=='Health staff' || this.currentrole=='Law Enforcement'|| this.currentrole=='Disaster Manager';
    ...
    this.health = this.currentrole=='Adminstrator'|| this.currentrole=='First Responder' || this.currentrole=='Emergency Responder' ||this.currentrole=='Disaster Manager';
