...
@Component({
  ...
  styleUrls: ['./incidentchart.component.css']
})
export class IncidentchartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.Incidentservice.Incidentchart()
    .subscribe(res=>{
      console.log(res);


      let DateTime = res.map(res=>res.UploadDate)
...
//Testing cases to remove a string from a number to plot the number only.
        ...
        this.chart = new Chart('canvas',{
          ...
          type:'bar',
          data:{
            labels:['November 2021' ,'December 2021','January 2022','February 2022','March 2022','April 2022','May 2022','June 2022','July 2022','August 2022','September 2022','October 2022','November 2022','December 2022' ],
          ...
          options: {
            ...
            scales: {
              ...
              yAxes: {
                ...
                title:{
                  display:true,
                  text:"Number of Incident Reports",
                  color:"black",
                  font:{
                    family: 'Times',
                    size: 20,
