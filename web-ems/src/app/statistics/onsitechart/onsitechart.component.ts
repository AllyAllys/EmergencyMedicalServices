...
@Component({
  ...
  styleUrls: ['./onsitechart.component.css']
})
export class OnsitechartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.onsitechartservice.onsiteChart()
    .subscribe(res=>{
      console.log(res);
          ...
          data:{
            ...
            datasets:[

              {
                ...
                backgroundColor:'rgb(19, 185, 185)',
                //fill:false,
