...
import { OrderChartService } from './orderschart.service';
...
export class OrderschartComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.orderchartservice.OrderChart()
    .subscribe(res=>{
      console.log(res);
          ...
          data:{
            ...
            datasets:[

              {
                ...
                label:"Number of Medical Orders",

                data:[Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov2,Dec2],
                backgroundColor:'rgb(96, 0, 160)',
                //fill:false,
